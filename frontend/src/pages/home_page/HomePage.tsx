        ...
        <div className="px-8 py6">
            ...
            <div className="flex-col pt-8">
                ...
                <div className="flex font-text text-xs mt-3 mx-2 gap-3 sm:gap-3 md:gap-6">
                    <Link to={"/contact"} className="px-2 py-1 border border-solid border-emerald-100 bg-[#D6D3CC] transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                        Let's Chat
                    </Link>
                    <button className="px-2 py-1 border border-solid border-emerald-100 transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">
                        View Work
                    </button>
                </div>
            </div>
