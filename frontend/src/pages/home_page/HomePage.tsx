            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-0 pt-8 md:pt-16">
                <div>
                    <div className="px-3 py-2">
                        <h1 className="font-heading font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl"><span className="text-glow-amber">Full-Stack</span> <span className="italic text-glow-blue">Developer</span>. <br /><span className="text-glow-amber">SEO</span> <span className="italic text-glow-blue">Engineer.</span> <br /><span className="italic text-glow-blue">Copywriter.</span></h1>
