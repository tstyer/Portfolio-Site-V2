...
export function HomePage() {
    return(
        <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6">
            ...
            {/* Hero */}
            <div className="flex-col pt-8 md:pt-16">
                <div className="px-3 py-2">
                    <h1 className="font-heading font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl">Full-Stack Developer. <br />SEO Engineer. <br />Copywriter.</h1>
